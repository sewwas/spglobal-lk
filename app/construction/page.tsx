...
import { HardHat, Building2, Ruler, Truck, Wrench } from 'lucide-react'
        ...
        <div className="relative h-[400px] rounded-2xl overflow-hidden mb-12">
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="w-full px-12 text-center">
              ...
              >
                Building <span className={`bg-clip-text text-transparent bg-gradient-to-r ${GOLDEN_GRADIENTS.primary}`}>
                  Sri Lanka's Future
                </span>
              </motion.h1>
              <motion.p 
              ...
              >
                Leading construction solutions with innovation and excellence
              </motion.p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="bg-gray-800/30 border border-gold/20 p-12 rounded-2xl">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Our construction services portal is under development. We're building something extraordinary for you.
            </p>
